...
% above. 
corr_frac = tarea_nh/tarea_Arctic; 
...
% Ensemble means
h0 = plot(time_axis,running_ave(squeeze(mean(mean(ICE(1:N_ens,mons,:),2),1)),10),'color',[82,82,82]/256); 
h1 = plot(time_axis,running_ave(squeeze(mean(mean(BARE(1:N_ens,mons,:),2),1)),10),'color',[35,139,69]/256); 
h2 = plot(time_axis,running_ave(squeeze(mean(mean(POND(1:N_ens,mons,:),2),1)),10),'color',[33,113,181]/256); 
h3 = plot(time_axis,running_ave(squeeze(mean(mean(SNOW(1:N_ens,mons,:),2),1)),10),'color',[203,24,29]/256); 
...
plot(time_axis,100*rsqc,'color',[228,26,28]/256)
hold on
plot(time_axis,100*rsqt,'color',[55,126,184]/256)
% plot(time_axis,100*rsqall,'color',[77,175,74]/256)
...
% 
% % Ensemble means
% h1 = plot(time_axis,running_ave(squeeze(mean(mean(BARE(1:N_ens,mons,:)./ICE(1:N_ens,mons,:),2),1)),10),'color',[35,139,69]/256); 
% h2 = plot(time_axis,running_ave(squeeze(mean(mean(POND(1:N_ens,mons,:)./ICE(1:N_ens,mons,:),2),1)),10),'color',[33,113,181]/256); 
% h3 = plot(time_axis,running_ave(squeeze(mean(mean(SNOW(1:N_ens,mons,:)./ICE(1:N_ens,mons,:),2),1)),10),'color',[203,24,29]/256); 
% 
% hold off
% grid on
% box on
...
%%
%saveas(gcf,'/Users/Horvat/Dropbox (Brown)/Apps/Overleaf/Albedo-Feedback-Thickness/Figures/Figure-5/Fig-5.fig')
%saveas(gcf,'/Users/Horvat/Dropbox (Brown)/Apps/Overleaf/Albedo-Feedback-Thickness/Figures/Figure-5/Fig-5.pdf')
